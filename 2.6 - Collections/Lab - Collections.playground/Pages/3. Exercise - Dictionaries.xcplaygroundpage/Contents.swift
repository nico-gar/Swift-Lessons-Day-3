...
var shapeColors = ["Circle":"red","Square":"Blue","Diamond":"Green"]

let shapesArray = Array(shapeColors.keys)
let colorsArray = Array(shapeColors.values)
print(shapesArray)
print(colorsArray)
...
print(colorsArray[2])
if let colorsLast = colorsArray.last {
    print(colorsLast)
}
/*:
