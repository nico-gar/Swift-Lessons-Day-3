 ...
 */
var walkingChallenges = ["Walk 3 miles a day", "Walk for 30 min a day"]
var runningChallenges = ["Run 3 miles a day", "Run for 30 min a day"]
...
}else if (committedChallenges.count != 0) {
